...
public class Televisao extends Produto {
    ...
    //Metodos
   // public Televisao(int codigo){};
  //  public Televisao(int codigo, String descricao, double preco){};
  //  public Televisao(int codigo, String descricao, double preco, int tamanho, String tecnologia){};
